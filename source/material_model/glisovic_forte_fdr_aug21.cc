...
#include <aspect/material_model/glisovic_forte_fdr_aug21.h>
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    template <int dim>
    void
    GlisovicForteFDRAug21<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection("Glisovic Forte FDR Aug21 model");
        {
    ...
    template <int dim>
    void
    GlisovicForteFDRAug21<dim>::parse_parameters (ParameterHandler &prm)
    {
...
namespace aspect
{
  namespace MaterialModel
  {
    ASPECT_REGISTER_MATERIAL_MODEL(GlisovicForteFDRAug21,
                                   "Glisovic Forte FDR Aug21",
                                   "")
  }
}
