...
#ifndef _aspect_material_model_glisovic_forte_fdr_h
#define _aspect_material_model_glisovic_forte_fdr_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class GlisovicForteFDR : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
