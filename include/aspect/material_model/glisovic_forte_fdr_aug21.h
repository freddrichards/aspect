...
#ifndef _aspect_material_model_glisovic_forte_fdr_aug21_h
#define _aspect_material_model_glisovic_forte_fdr_aug21_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class GlisovicForteFDRAug21 : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
