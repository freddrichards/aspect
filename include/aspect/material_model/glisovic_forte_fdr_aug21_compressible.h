...
#ifndef _aspect_material_model_glisovic_forte_fdr_aug21_compressible_h
#define _aspect_material_model_glisovic_forte_fdr_aug21_compressible_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class GlisovicForteFDRAug21Compressible : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
